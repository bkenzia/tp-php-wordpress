...
define( 'BOXTAL_CONNECT_VERSION', '1.2.12' );
...
function boxtal_connect_init() {
	...
	if ( false === Environment_Util::check_errors( $plugin ) ) {
		...
		if ( Auth_Util::can_use_plugin() ) {
			...
			$plugin['boxtal-connect-api-action']         = 'boxtal_connect_init_api_action';
...
/**
 * Initializes common dev hooks.
 *
 * @param array $plugin plugin array.
 * @return Translation $object static translation instance.
 */
function boxtal_connect_init_api_action( $plugin ) {
	static $object;
